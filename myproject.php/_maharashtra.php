...
<div class="header my-5">
    <h3 class="text-center">Welcome to Maharashtra Covid Facilities</h3>
</div>
...
<input id="input" class="form-control mr-sm-2" type="search" placeholder="Search Your District Wise Hospitals" aria-label="Search" onkeyup="searchstatehelp()">
  ...
  <tr>
      <th scope="row">1</th>
      <td>Navi Mumbai</td>
      <td><a href="https://nmmchealthfacilities.com/HospitalInfo/showhospitalist">Detail Info</a></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Pune</td>
      <td><a href="https://www.divcommpunecovid.com/ccsbeddashboard/hsr">Detail Info</a></td>
    </tr>
    <tr>
      <th scope="row">3</th>
      <td>Thane</td>
      <td><a href="https://covidthane.org/availabiltyOfHospitalBeds.html">Detail Info</a></td>
    </tr>
    <tr>
      <th scope="row">4</th>
      <td>Nagpur</td>
      <td><a href="http://nsscdcl.org/covidbeds/AvailableHospitals.jsp">Detail Info</a></td>
    </tr>
    <tr>
    <tr>
      <th scope="row">5</th>
      <td>Nashik</td>
      <td><a href="http://covidcbrs.nmc.gov.in/home/hospitalSummary">Detail Info</a></td>
    </tr>
    <tr>
