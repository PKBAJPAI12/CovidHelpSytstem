...
<div class="header my-5">
    <h3 class="text-center">Welcome to Haryana Covid Facilities</h3>
</div>
...
<input id="input" class="form-control mr-sm-2" type="search" placeholder="Search Your District Wise Hospitals" aria-label="Search" onkeyup="searchstatehelp()">
  ...
  <tr>
      <th scope="row">1</th>
      <td>Haryana</td>
      <td><a href="https://coronaharyana.in/">Detail Info</a></td>
    </tr>
    <tr>
      <th scope="row">2</th>
      <td>Gurgoan</td>
      <td><a href="https://covidggn.com/public/pages/gurugram-hospitals">Detail Info</a></td>
    </tr>
